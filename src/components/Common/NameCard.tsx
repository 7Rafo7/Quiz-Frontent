...
const NameCard: React.FC<IProps> = ({usernameError, username, onNameInputChange, startHandler}) => {
    ...
    <Card style={{marginTop: 100}}>
      ...
      <Card.Body>
        <Form.Group className="mb-3">
          <Form.Control className={usernameError ? 'is-invalid' : ''} name="name" type="text"
                        placeholder="Name" value={username} onChange={handleNameInputChange}/>
